...
# how can we classify feature sets?
...
def create_feature_sets_and_labels(sarcasmset,test_size = 0.1):
    lexicon = create_lexicon(sarcasmset)
    features=[]
    features+=sample_handling(sarcasmset,lexicon)
...
if __name__ == '__main__':
    train_x,train_y,test_x,test_y = create_feature_sets_and_labels(sarcasmdataset)
